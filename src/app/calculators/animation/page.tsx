...
export default function AnimationPage() {
  ...
  const calculatePrice = () => {
    ...
    setTimeout(() => {
      const calculatedPrice = calculateAnimationPrice(
        resolution,
        aspectRatio,
        fps,
        complexity,
      ...
      const priceBreakdown = getPriceBreakdown('animation', finalPrice, {
        resolution,
        aspectRatio,
        fps,
        complexity,
  ...
  return (
    <div className="flex flex-col min-h-screen dark:text-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 animate-fade-in">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 text-transparent bg-clip-text mb-2">3D Animation Pricing</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">Calculate accurate pricing for your 3D animation projects</p>
